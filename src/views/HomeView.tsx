...
import { useMusicContext, initialMusicState, type MusicViewState } from '../context/MusicContext';
import { PhraseCard } from '../components/PhraseCard';
import { Sparkles, Brain, Calendar, Music as MusicIcon, Tag, CheckCircle2, RefreshCw, ArrowLeft } from 'lucide-react';
...
const HomeSongView = React.memo(function HomeSongView({ 
    song, 
    onClose,
    apiKey,
    language,
    ...
    useEffect(() => {
        const loadLyrics = async () => {
            ...
            try {
                ...
                alert(t('music.failedGenerateMaterials').replace('{{error}}', (err as Error).message));
            } finally {
